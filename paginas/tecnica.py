...
def display():
    ...
    ingresos_url = "https://cdn.www.gob.pe/uploads/document/file/5901305/5207826-tecnicas_mp_nacional.xlsx"
    demanda_url = "https://cdn.www.gob.pe/uploads/document/file/5988189/5306104-md_tecnicas_nacional.xlsx"
    ...
    def load_ingresos_data(url):
        ...
        """
        # Cargar las columnas C, D, E; filas 5 a 35 (31 filas)
        df = pd.read_excel(url, usecols="C:E", skiprows=4, nrows=31)
    ...
    def load_demanda_data(url):
        ...
        """
        # Cargar las columnas C y D; filas 5 a 43 (39 filas)
        df = pd.read_excel(url, usecols="C:D", skiprows=4, nrows=39)
    ...
    fig3 = px.scatter(
        ...
        trendline='ols',  # Eliminar esta línea si no instalas statsmodels
        template='plotly_white'
    )
    ...
    <div style="text-align: left; font-size: 10px; margin-top: 50px;">
        ...
        PROFESIONALES TÉCNICOS, SEGÚN FAMILIA DE CARRERAS, NOVIEMBRE 2022 - OCTUBRE 2023. (Soles)<br>
        ...
        <strong>PERÚ:</strong> PERSONAL QUE LAS EMPRESAS CONTRATARÍAN PARA OCUPAR NUEVOS PUESTOS DE TRABAJO DE NATURALEZA PERMANENTE PARA PROFESIONALES TÉCNICOS, SEGÚN CARRERAS, 2024<br>
        (1) Las denominaciones de familias de carreras corresponden a la agrupación a 3 dígitos (Campo Detallado) del “Clasificador de Carreras de Educación Superior y Técnico Productivas, 2014” del INEI.<br>
        (2) Otras Carreras de Administración comprende las siguientes carreras a 6 dígitos: Administración de Recursos Humanos, Administración de Servicios de Postales, Administrativo, Agencia de Desarrollo Integral, Planificación Empresarial, Planificación y Gestión de Desarrollo, y Supervisión de Operaciones.<br>
        (3) Otras Carreras de Educación comprende la siguiente carrera a 6 dígitos: Educación (Incluye Educación Básica Alternativa).<br>
